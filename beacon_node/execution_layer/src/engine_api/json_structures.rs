...
impl From<PayloadStatusV1Status> for JsonPayloadStatusV1Status {
    fn from(e: PayloadStatusV1Status) -> Self {
        match e {
            ...
            PayloadStatusV1Status::InclusionListUnsatisfied => JsonPayloadStatusV1Status::InclusionListUnsatisfied,
        }
    }
}
impl From<JsonPayloadStatusV1Status> for PayloadStatusV1Status {
    fn from(j: JsonPayloadStatusV1Status) -> Self {
        match j {
            ...
            JsonPayloadStatusV1Status::InclusionListUnsatisfied => PayloadStatusV1Status::InclusionListUnsatisfied,
        }
    }
}
