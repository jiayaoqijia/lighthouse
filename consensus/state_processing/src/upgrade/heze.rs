...
use types::{
    ...
    ExecutionPayloadBid, ExecutionPayloadBidHeze, Fork,
};
...
pub fn upgrade_state_to_heze<E: EthSpec>(
    ...
    let post = BeaconState::Heze(BeaconStateHeze {
        ...
        // Execution Bid - [Modified in Heze:EIP7805]
        // Add inclusion_list_bits field, initialized to all zeros
        latest_execution_payload_bid: ExecutionPayloadBid::Heze(ExecutionPayloadBidHeze {
            ...
            // [New in Heze:EIP7805] Initialize inclusion_list_bits to all zeros
            inclusion_list_bits: BitVector::<U16>::default(),
        }),
        // Capella
