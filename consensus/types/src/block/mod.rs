...
pub use beacon_block::{
    ...
    BeaconBlockDeneb, BeaconBlockElectra, BeaconBlockFulu, BeaconBlockGloas, BeaconBlockHeze, BeaconBlockRef,
...
pub use beacon_block_body::{
    ...
    BeaconBlockBodyFulu, BeaconBlockBodyGloas, BeaconBlockBodyHeze, BeaconBlockBodyRef, BeaconBlockBodyRefMut,
...
pub use signed_beacon_block::{
    ...
    SignedBeaconBlockFulu, SignedBeaconBlockGloas, SignedBeaconBlockHeze, SignedBeaconBlockHash, SignedBlindedBeaconBlock,
